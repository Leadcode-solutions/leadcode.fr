...
|
*/
Encore.addEntry('app', join(process.cwd(), 'apps', 'Public', 'Resources', 'js', 'app.js'))
Encore.addEntry('shared', join(process.cwd(), 'apps', 'Shared', 'Resources', 'js', 'app.js'))
Encore.addEntry('manager', join(process.cwd(), 'apps', 'Manager', 'Resources', 'js', 'app.tsx'))
...
*/
Encore.copyFiles({
  from: './app/Public/Resources/images',
...
Encore.configureDevServerOptions((options) => {
  ...
  options.static.push({
    directory: join(__dirname, './apps/Public/Resources/views'),
    watch: true,
  })

  options.static.push({
    directory: join(__dirname, './apps/Manager/Resources/views'),
    watch: true,
  })
})
